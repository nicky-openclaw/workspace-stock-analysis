...
第一行：白线/黄线数值，间距，MA状态，位置描述，放量情况，涨跌情况
第二行：RSI｜J值｜涨幅（纯数字，一行扫完）
第三行：评分构成：关键加分项+分值（精简到6项以内，|分隔）
第四行：⚠️ 风险提示（独立一行，🔴 标记极高风险）
```

**示例**：
```
白线 30.78 > 黄线 30.41，间距 0.37 元，均线多头排列。今日站回白线，突破20日+60日高点，放量4.37x，涨停。

RSI 80.68｜J值 76.55｜涨幅 19.99%

评分构成：放量2.5x+30 | 大阳线+10 | 站回白线+3 | 涨停+15 | 突破60日高点+20

⚠️ 涨幅19.99%逼近涨停，明日防获利盘。量比4.37x异常放量，次日可能缩量整理。
```
